  ...
  return (
    <div className="w-[100vw] h-[100vh] bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center gap-4 px-4">
        ...
        <Link href='/home' className="bg-black w-[80vw] max-w-[400px] h-[60px] sm:h-[80px] relative rounded-xl flex items-center justify-center cursor-pointer hover:scale-105 transition-transform duration-200 opacity-0 animate-scale-up animation-delay-1600">
